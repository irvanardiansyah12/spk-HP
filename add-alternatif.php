							...
							<form role="form" method="post" action="add.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alternatif" id="alternatif" placeholder="Alternatif Gadget">
                                        </div>
																				<div class="form-group">
                                            <label for="alternatif">C1 Harga</label>
                                            <input type="text" class="form-control" name="k1" id="alternatif" placeholder="Harga">
                                        </div>
